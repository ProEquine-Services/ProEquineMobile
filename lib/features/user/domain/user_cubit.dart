...
import 'package:proequine_dev/features/user/data/check_verification_request_model.dart';
import 'package:proequine_dev/features/user/data/interests_request_model.dart';
import 'package:proequine_dev/features/user/data/login_response_model.dart';
import 'package:proequine_dev/features/user/data/register_request_model.dart';
import 'package:proequine_dev/features/user/data/reset_password_request_model.dart';
import 'package:proequine_dev/features/user/data/send_verify_request_forgot_password.dart';
import 'package:proequine_dev/features/stables/data/stable-model.dart';
import 'package:proequine_dev/features/user/data/update_email_request_model.dart';
import 'package:proequine_dev/features/user/domain/repo/user_repository.dart';
...
class UserCubit extends Cubit<UserState> {
  ...
  Future<void> login(LoginRequestModel loginRequestModel) async {
    ...
    if (response is LoginResponseModel) {
      ...
      emit(LoginSuccessful(model: response));
  ...
  Future<void> register(RegisterRequestModel registerRequestModel) async {
    ...
    if (response is LoginResponseModel) {
      ...
      emit(RegisterSuccessful(model: response));
    } else if (response is BaseError) {
      Print("messaggeeeeeeeee${response.message}");
  ...
  Future<void> sendVerificationCode() async {
    ...
    if (response is EmptyModel) {
      emit(SendVerificationSuccessful(
          message: "New OTP code is sent".tra));
    } else if (response is BaseError) {
      Print("messaggeeeeeeeee${response.message}");
  ...
  Future<void> sendVerificationCodeForgotPassword(
    ...
    if (response is EmptyModel) {
      emit(
          ForgotPasswordSuccessful(message: "New OTP code is sent ".tra));
    } else if (response is BaseError) {
      Print("messaggeeeeeeeee${response.message}");
  ...
  Future<void> checkMailVerificationCode(
    ...
    if (response is RegisterResponseModel) {
      ...
      emit(CheckMailVerificationSuccessful(
          message: "E-mail updated successfully.".tra));
    } else if (response is BaseError) {
      Print("messaggeeeeeeeee${response.message}");
