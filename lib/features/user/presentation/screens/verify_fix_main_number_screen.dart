...
import 'package:proequine_dev/features/manage_account/data/edit_phone_request_model.dart';
import 'package:proequine_dev/features/manage_account/data/update_main_number_request_model.dart';
...
class VerifyFixMainNumberScreen extends StatefulWidget {
  final String? phoneNumber;

  const VerifyFixMainNumberScreen({
    super.key,
    this.phoneNumber,
  });

  @override
  State<VerifyFixMainNumberScreen> createState() =>
      _VerifyFixMainNumberScreenState();
}

class _VerifyFixMainNumberScreenState extends State<VerifyFixMainNumberScreen> {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "A 4 digit verification code has been sent to ${widget.phoneNumber}",
                          ...
                          : Center(
                              child: InkWell(
                                onTap: () {
                                  setState(() {
                                    context
                                        .read<ManageAccountCubit>()
                                        .sendPhoneNumber(EditPhoneRequestModel(
                          ...
                          return RebiButton(
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                onPressVerify(widget.phoneNumber!);
                              } else {}
                            },
                            child: Text(
                              "Confirm",
