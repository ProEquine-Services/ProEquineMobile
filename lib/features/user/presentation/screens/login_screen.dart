...
import 'package:proequine_dev/core/widgets/custom_logo_widget.dart';
import 'package:proequine_dev/core/widgets/rebi_button.dart';
import 'package:proequine_dev/core/widgets/rebi_input.dart';
import 'package:proequine_dev/features/uncompleted_customers/presentation/screens/missing_details_screen.dart';
import 'package:proequine_dev/features/user/domain/user_cubit.dart';
import 'package:proequine_dev/features/stables/presentation/screens/choose_stable_screen.dart';
import 'package:proequine_dev/features/user/presentation/screens/create_user_name_screen.dart';
import 'package:proequine_dev/features/user/presentation/screens/forget_password_screen.dart';
        ...
        listener: (context, state) {
          ...
          if (state is LoginSuccessful) {
            if (!state.model!.isLoggedInBefore!) {
              if (state.model!.isPhoneNumberGenerated! &&
                  state.model!.isEmailGenerated == false) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MissingDetailsScreen(
                              phoneGenerated: true,
                              emailGenerated: false,
                              phone: state.model!.email,
                            )));
              } else if (state.model!.isEmailGenerated! &&
                  state.model!.isPhoneNumberGenerated == false) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MissingDetailsScreen(
                            phone: state.model!.phoneNumber,
                            phoneGenerated: false,
                            emailGenerated: true)));
              } else if (state.model!.isPhoneNumberGenerated == false &&
                  state.model!.isEmailGenerated == false) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            } else if (!AppSharedPreferences.getPhoneVerified!) {
