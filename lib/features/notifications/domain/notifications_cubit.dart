...
import 'package:proequine_dev/features/notifications/domain/repo/notifications_repository.dart';
...
class NotificationsCubit extends Cubit<NotificationsState> {
  ...
  Future<void> configOneSignal() async {
    ...
    OneSignal.Notifications.addForegroundWillDisplayListener((event) {
      ...
      Print("The notification body is :${event.notification.body}");
      if(event.notification.body=='Your account has been verified'){
