...
import 'package:proequine_dev/features/splash/domain/splash_cubit.dart';
...
class SplashScreenState extends State<SplashScreen>
  ...
  Future<void> navigateUser() async {
    Print('phone verified ${AppSharedPreferences.getPhoneVerified}');
    ...
    if (SavedNotificationData.notificationData != null) {
      ...
      if (await SecureStorage().getToken() != null) {
        if ((AppSharedPreferences.getPhoneVerified!) ||
            (!AppSharedPreferences.getPhoneVerified! &&
                AppSharedPreferences.isHasUserName == true)) {
