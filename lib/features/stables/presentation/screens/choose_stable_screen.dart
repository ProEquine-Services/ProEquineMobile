...
import 'package:proequine_dev/features/stables/data/chose_stable_request_model.dart';
import 'package:proequine_dev/features/stables/domain/stable_cubit.dart';
  ...
  _onPressConfirm() {
    return cubit
      ..choseStable(ChoseMainStableRequestModel(
        id: isChooseToAddStable ? -1 : int.parse(stableId.text),
        isUpdated: false,
