...
class SuccessStripePaymentInvoice extends StatefulWidget {
  final String paymentTime;
  final String paymentAmount;
  final String invoiceNumber;

  const SuccessStripePaymentInvoice(
      {Key? key,
  ...
  @override
  State<SuccessStripePaymentInvoice> createState() =>
      _SuccessStripePaymentInvoice();
}

class _SuccessStripePaymentInvoice
    extends State<SuccessStripePaymentInvoice> {
                        ...
                        children: [
                          Center(
                              child: SvgPicture.asset(
                                  AppIcons.invoiceSuccessPayment)),
                          const SizedBox(
                            height: 10,
                          ),
                          Text(
