...
import 'package:proequine_dev/features/invoices/presentation/screens/success_payment_invoice_screen.dart';
...
class _InvoiceDetailsScreenState extends State<InvoiceDetailsScreen> {
  ...
  String get lessThanInputText {
    if (widget.invoice.invoiceDetails!.total!.toDouble() != null) {
      try {
        double inputValue = double.parse(widget.invoice.invoiceDetails!.total.toString());
        double moreValue = inputValue * (1 - 0.029) - 1;
        double newValue = (inputValue * inputValue) /
            moreValue; // 2.9% more than the input plus 1 AED
                ...
                ? BlocConsumer<InvoicesCubit, InvoicesState>(
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => FailedPaymentScreen(
                                    ...
                                    paymentAmount: lessThanInputText)));
                    ...
                    builder: (context, state) {
                      ...
                      return RebiButton(
                        onPressed: () {
                          onPressCharge(
                              double.parse(lessThanInputText)
                                  .toInt(),
                              context);
                        },
                        child: Text(
                      ...
                      return RebiButton(
                        onPressed: () {
                          if (selectedPaymentMethod != null) {
                            ...
                            RebiMessage.error(
                                msg: "Select payment method", context: context);
                          }
                        },
                        child: Text(
                          "Pay",
