...
import '../data/add_new_stable_request_model.dart';
import '../data/add_new_stable_response_model.dart';
import '../data/add_seccondary_stable_model.dart';
import '../data/add_secondary_discipline_request_model.dart';
import '../data/add_secondary_interests_response_model.dart';
import '../data/get_user_disciplines_response_model.dart';
import '../data/get_user_roles_response_model.dart';
import '../data/get_user_stables_response_model.dart';
import '../data/update_secondary_discipline_request_model.dart';
import 'equine_info_repository/equine_info_repository.dart';
...
class EquineInfoCubit extends Cubit<EquineInfoState> {
  ...
  Future<void> addSecondaryStable(
      AddSecondaryStableModel addSecondaryStableModel) async {
